//
//  OperatingIncomeChartView.swift
//  Ekonix
//
//  Created for operating income quarterly chart
//

import SwiftUI

struct OperatingIncomeChartView: View {
    let symbol: String
        ...
        ZStack {
            if isLoading {
                ...
                VStack(spacing: 20) {
                    ...
                    Text("No operating income data available")
                ...
                ScrollView {
                    VStack(spacing: 20) {
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            Text("Quarterly Operating Income")
                                .font(.headline)
    ...
    private func loadOperatingIncome() {
        ...
        Task {
            do {
                let data = try await apiService.fetchOperatingIncome(symbol: symbol)
                await MainActor.run {
