//
//  TTMFreeCashFlowChartView.swift
//  Ekonix
//
...
struct TTMFreeCashFlowChartView: View {
    let symbol: String
                ...
                ScrollView {
                    VStack(spacing: 20) {
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            Text("Trailing Twelve Months Free Cash Flow")
                                .font(.headline)
    ...
    private func loadFreeCashFlow() {
        ...
        Task {
            do {
                let data = try await apiService.fetchTTMFreeCashFlow(symbol: symbol)
                await MainActor.run {
